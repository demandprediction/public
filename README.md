...
```bash
  ...
  ├── notebooks  ** NOT PUBLIC YET **                             
  │    ├── 1_Introduction.ipynb                                         # Introduction
  ...
  │    ├── 5_Clustering Techniques.ipynb                                # Clustering Techniques  
  │    ├── 6_Evaluation and Visualization.ipynb                         # Evaluation and Visualization
  │    ├── 7_More Advanced Methods.ipynbb                               # Advanced Methods 
  │    └── 8_Appendix.ipynb                                             # Appendix 
